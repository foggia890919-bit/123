...
import { Building2, Filter, X, Upload, Send, FileText, ChevronDown, Plus, Trash2 } from "lucide-react";
                          ...
                          {filteredClients.length === 0 ? (
                            ...
                            <div key={c.id} className="flex items-center hover:bg-gray-50 group">
                              ...
                              <button type="button" onClick={() => handleDeleteClient(c.id)}
                                className="px-2 py-2 opacity-0 group-hover:opacity-100 text-gray-400 hover:text-red-500">
