...
import type { OcrResult, FusionDrug, ManualDrug, UserClient, ColumnTemplate, PipelineDiagnostics, EmrVendor, CaptureType } from "./components/types";
import { VENDOR_LABEL_KO, CAPTURE_LABEL_KO, emptyManualDrug } from "./components/types";
