...
function UploadTab() {
  ...
  const [mapResult, setMapResult] = useState<{ success?: boolean; mapped?: number; updated?: number; ingredientUpdated?: number; total?: number; filled?: number; lastSync?: string | null; error?: string; sampleKeys?: string[] } | null>(null);
