    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2 items-center flex-wrap">
          ...
          <Link href="/admin/sales/keywords" className="px-3 py-2 rounded-md border text-sm">키워드룰</Link>
          <Link href="/admin/sales/costs" className="px-3 py-2 rounded-md bg-gray-900 text-white text-sm">원가/매핑</Link>
