export type UserRole = "BASIC" | "BUSINESS" | "BIZ" | "ADMIN" | "DOCTOR" | "PHARMACIST";
...
export const FEATURE_ROLES = {
  ...
  commission: "BUSINESS",  // 수수료율 표시
  settlement: "BUSINESS",  // 정산제약사 검색
  download: "BUSINESS",    // 리스트 다운
  proposals: "BUSINESS",   // 제안서 (기본)
  filter: "BIZ",            // 제약사 필터링
